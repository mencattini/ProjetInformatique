...
mysql --user=root --password=$MYSQL_ROOT_PASSWORD < /docker_entrypoint-initdb.d/schema.sql
mysql --user=root --password=$MYSQL_ROOT_PASSWORD < /docker_entrypoint-initdb.d/init_data.sql
